...
export function BlochSphere({
    ...
    useFrame((_state, delta) => {
        if (animState.current.active) {
            ...
            const remaining =
                Math.abs(animState.current.targetAngle) -
                Math.abs(animState.current.currentAngle);
            ...
            const tempQ = animState.current.startQuaternion
                .clone()
                .premultiply(partialRot);
            ...
            if (isFinished) {
                ...
                const dotPosition = new THREE.Vector3(0, 0, 1).applyQuaternion(
                    tempQ,
                );
                ...
                <group>
                    ...
                    {targetCircle && (
                        ...
                        >
                            <ringGeometry
                                args={[
                                    targetCircle.circleRadius,
                                    targetCircle.circleRadius + 0.02,
                                    64,
                                ]}
                            />
                            <meshBasicMaterial
